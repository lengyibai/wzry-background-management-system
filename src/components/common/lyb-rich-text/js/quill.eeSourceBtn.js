  ...
  addDom(quill) {
    if (!quill.container.querySelector(".ql-ee-source")) {
      ...
      txtArea.style.cssText =
        "width: 100%;margin: 0px;background: rgba(0, 0, 0, 0.75);color:#fff;box-sizing: none;font-size: 20px;outline: none;padding: 12px 15px;line-height: 1.42;font-family: Consolas, Menlo, Monaco, &quot;Courier New&quot;, monospace;position: absolute;top: 0;bottom: 0;border: none;";
